...
console.log('Session Secret:', _config["default"].oauth.sessionSecret);
console.log('Google Client ID:', _config["default"].oauth.googleClientId);
console.log('Google Client Secret:', _config["default"].oauth.googleClientSecret);
